...
<div class="con">
    <div class="card">
        ...
        <form autocomplete="off" method="post" action="/member/login">
            ...
            <div class="login">
                <!--       Already a member -->
                <label id="register" for="register"><p> Already a member! <a href="/member/register"><span> Register </span></a></p></label>
            </div>
        </form>
